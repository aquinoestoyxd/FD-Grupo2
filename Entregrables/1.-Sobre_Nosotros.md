...
Estudiante de Ingeniería Informática con un fuerte interés en el desarrollo de tecnologías sostenibles y amigables con el medio ambiente. Apasionado por la programación y la electrónica, cuenta con experiencia en proyectos con Arduino, web scraping y algoritmos de procesamiento de datos. Siempre en busca de nuevas herramientas tecnológicas, le motiva aplicarlas en proyectos prácticos e innovadores. Se considera una persona analítica, perseverante y con visión para la innovación en distintos ámbitos. 

**Rol a desempeñar:** 

*"Coordinador de Electrónica y Logística"*.Responsable de diseñar, ensamblar los circuitos y garantizar que los componentes funcionen de manera óptima. Además, se encargado de probar y ajustar el hardware para asegurar que el sistema sea eficiente y cumpla con los objetivos del proyecto.
