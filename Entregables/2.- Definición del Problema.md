...
Medir el pH del lago es crucial para poder determinar la actividad bacteriana, ya que al conocer su pH podemos comprender mejor como podemos tratar el problema de la contaminación por bacteiras. Ya que se pueden plantear medidaes para modificar el pH del lago, haciendolo una fuente de agua imposible para que sobrevivan las bacterias. Por esos motivos, para el proyecto se decidió tomar como métrica la presencia de ph en el agua. De acuerdo a Kundan Kumar (2024), plataformas de detección rápida basadas en sensores electroanalíticos logran identificar E. coli mediante la medición de señales eléctricas influenciadas por los cambios químicos del entorno, entre ellos, el pH (5). Esto refuerza la viabilidad de utilizar sensores de pH como método indirecto y eficaz para la detección temprana de esta bacteria.
